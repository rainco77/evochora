...
public final class LayoutContext {
	...
	private final Map<List<Integer>, Integer> coordToLinear = new HashMap<>();
	...
	public void placeOpcode(SourceInfo src) {
		...
		coordToLinear.put(Nd.toList(currentPos), linearAddress);
	...
	public Map<List<Integer>, Integer> coordToLinear() { return coordToLinear; }
