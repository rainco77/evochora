...
public class HeaderController {
    ...
    public HeaderController(Simulation simulation) {
        ...
        this.playPauseButton = new Button(LocalizationProvider.getString("header.button.playPause"));
        this.nextTickButton = new Button(LocalizationProvider.getString("header.button.nextTick"));
        this.restartButton = new Button(LocalizationProvider.getString("header.button.restart"));
        this.loggingToggleButton = new Button(LocalizationProvider.getString("header.button.loggingOff"));
        this.zoomToggleButton = new Button(LocalizationProvider.getString("header.button.zoomNormal")); // NEW: Initial text
        this.tickLabel = new Label(String.format(LocalizationProvider.getString("header.label.tick"), 0));
