// src/main/java/org/evochora/organism/AddrInstruction.java
...
public class AddrInstruction extends Instruction {
    ...
    public AddrInstruction(Organism o, int r1, int r2) {
        super(o);
        this.reg1 = r1;
        this.reg2 = r2;
    }
    ...
    static {
        Instruction.registerInstruction(AddrInstruction.class, ID, "ADDR", 3, AddrInstruction::plan, AddrInstruction::assemble);
    ...
    public ArgumentType getArgumentType(int argIndex) {
        ...
        throw new IllegalArgumentException("Ungültiger Argumentindex für ADDR: " + argIndex);
    }
    ...
    public static Instruction plan(Organism organism, World world) {
        ...
        return new AddrInstruction(organism, r1, r2);
    }

    public static AssemblerOutput assemble(String[] args, Map<String, Integer> registerMap, Map<String, Integer> labelMap) {
        if (args.length != 2) throw new IllegalArgumentException("ADDR erwartet 2 Argumente: %REG1 %REG2");
    ...
    public void execute(Simulation simulation) {
        ...
        if (val1Obj instanceof int[] v1 && val2Obj instanceof int[] v2) {
            if (v1.length != v2.length) {
                organism.instructionFailed("ADDR: Vektor-Dimensionen stimmen nicht überein. Reg " + reg1 + " (" + v1.length + ") vs Reg " + reg2 + " (" + v2.length + ").");
                return;
            }
            ...
            if (Config.STRICT_TYPING) {
                ...
                if (s1.type() != s2.type()) {
                    organism.instructionFailed("ADDR: Registertypen müssen übereinstimmen im strikten Modus. Reg " + reg1 + " (" + s1.type() + ") vs Reg " + reg2 + " (" + s2.type() + ").");
                    return;
                }
            ...
            organism.instructionFailed("ADDR: Ungültige Argumenttypen. Beide Register müssen entweder Skalare oder Vektoren sein.");
        }
    }
}