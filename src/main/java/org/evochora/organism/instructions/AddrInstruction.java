...
public class AddrInstruction extends Instruction {
    ...
    public AddrInstruction(Organism o, int r1, int r2, int fullOpcodeId) {
    ...
    public void execute(Simulation simulation) {
        ...
        if (val1Obj instanceof int[] v1 && val2Obj instanceof int[] v2) {
            if (v1.length != v2.length) {
                organism.instructionFailed("ADDR: Vektor-Dimensionen stimmen nicht überein.");
                return;
            }
            ...
            if (Config.STRICT_TYPING && s1.type() != s2.type()) {
                organism.instructionFailed("ADDR: Registertypen müssen im strikten Modus übereinstimmen.");
                return;
            }
    ...
    public static Instruction plan(Organism organism, World world) {
        ...
        return new AddrInstruction(organism, r1, r2, fullOpcodeId);
    }
