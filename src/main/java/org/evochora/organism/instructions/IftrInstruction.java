...
public class IftrInstruction extends Instruction {
    ...
    public IftrInstruction(Organism o, int r1, int r2, int fullOpcodeId) {
    ...
    public static Instruction plan(Organism organism, World world) {
        ...
        return new IftrInstruction(organism, r1, r2, fullOpcodeId);
    }

    public static AssemblerOutput assemble(String[] args, Map<String, Integer> registerMap, Map<String, Integer> labelMap) {
        if (args.length != 2) throw new IllegalArgumentException("IFTR erwartet genau 2 Register-Argumente: %REG1 %REG2");
