...
public class SubiInstruction extends Instruction {
    ...
    public SubiInstruction(Organism o, int r1, int literal, int fullOpcodeId) {
    ...
    public void execute(Simulation simulation) {
        ...
        if (val1Obj instanceof Integer v1Raw) {
            ...
            if (Config.STRICT_TYPING && s1.type() != s2.type()) {
                organism.instructionFailed("SUBI: Register- und Literal-Typen müssen im strikten Modus übereinstimmen.");
                return;
            }
    ...
    public static Instruction plan(Organism organism, World world) {
        ...
        return new SubiInstruction(organism, r1, literal, fullOpcodeId);
    }

    public static AssemblerOutput assemble(String[] args, Map<String, Integer> registerMap, Map<String, Integer> labelMap) {
        if (args.length != 2) throw new IllegalArgumentException("SUBI erwartet genau 2 Argumente: %REG TYPE:WERT");
