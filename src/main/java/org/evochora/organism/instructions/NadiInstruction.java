...
public class NadiInstruction extends Instruction {
    ...
    public NadiInstruction(Organism o, int r1, int literal, int fullOpcodeId) {
    ...
    public void execute(Simulation simulation) {
        ...
        if (Config.STRICT_TYPING && s1.type() != s2.type()) {
            organism.instructionFailed("NADI: Register- und Literal-Typen müssen im strikten Modus übereinstimmen.");
            return;
        }
    ...
    public static Instruction plan(Organism organism, World world) {
        ...
        return new NadiInstruction(organism, r1, literal, fullOpcodeId);
    }
