// src/main/java/org/evochora/organism/SubiInstruction.java
...
public class SubiInstruction extends Instruction {
    ...
    public SubiInstruction(Organism o, int r1, int literal) {
        super(o);
        this.reg1 = r1;
    ...
    static {
        Instruction.registerInstruction(SubiInstruction.class, ID, "SUBI", 3, SubiInstruction::plan, SubiInstruction::assemble);
    ...
    public ArgumentType getArgumentType(int argIndex) {
        ...
        throw new IllegalArgumentException("Ungültiger Argumentindex für SUBI: " + argIndex);
    }
    ...
    public static Instruction plan(Organism organism, World world) {
        ...
        return new SubiInstruction(organism, r1, literal);
    }

    public static AssemblerOutput assemble(String[] args, Map<String, Integer> registerMap, Map<String, Integer> labelMap) {
        if (args.length != 2) {
            throw new IllegalArgumentException("SUBI erwartet genau 2 Argumente: %REG TYPE:WERT");
        }
    ...
    public void execute(Simulation simulation) {
        ...
        if (val1Obj instanceof Integer v1Raw) {
            ...
            if (Config.STRICT_TYPING && s1.type() != s2.type()) {
                organism.instructionFailed("SUBI: Register- und Literal-Typen müssen übereinstimmen im strikten Modus.");
                return;
            }
            ...
            organism.instructionFailed("SUBI: Ungültiger Argumenttyp. Register " + reg1 + " muss ein Skalar sein.");
        }
    }
}