...
public class AssemblerConditionalInstructionTest {
    ...
    void testIfr_True() {
        ...
        org.setDr(1, new Symbol(Config.TYPE_DATA, 5).toInt());
    ...
    void testIfi_False() {
        ...
        Organism finalOrg = runAssembly(code, org, 2);
        assertThat(finalOrg.getDr(0)).isEqualTo(new Symbol(Config.TYPE_DATA, 10).toInt());
    }
    ...
    void testIfs_True() {
        ...
        Organism finalOrg = runAssembly(code, org, 2);
        assertThat(finalOrg.getDr(0)).isEqualTo(new Symbol(Config.TYPE_DATA, 1).toInt());
    }
    ...
    void testIfs_False() {
        ...
        org.setDr(0, new Symbol(Config.TYPE_DATA, 0).toInt());
        org.getDataStack().push(new Symbol(Config.TYPE_DATA, 7).toInt());
        org.getDataStack().push(new Symbol(Config.TYPE_DATA, 8).toInt());
        List<String> code = List.of("IFS", "ADDI %DR0 DATA:1");
        Organism finalOrg = runAssembly(code, org, 1);
        assertThat(finalOrg.getDr(0)).isEqualTo(new Symbol(Config.TYPE_DATA, 0).toInt());
    }
    ...
    void testLtr_True_then_False() {
        ...
        orgT.setDr(0, new Symbol(Config.TYPE_DATA, 1).toInt());
        orgT.setDr(1, new Symbol(Config.TYPE_DATA, 2).toInt());
        Organism resT = runAssembly(List.of("LTR %DR0 %DR1", "ADDI %DR0 DATA:1"), orgT, 2);
        assertThat(resT.getDr(0)).isEqualTo(new Symbol(Config.TYPE_DATA, 2).toInt());
        // False
        Organism orgF = Organism.create(sim, new int[]{0,0}, 1000, sim.getLogger());
        orgF.setDr(0, new Symbol(Config.TYPE_DATA, 2).toInt());
        orgF.setDr(1, new Symbol(Config.TYPE_DATA, 1).toInt());
        Organism resF = runAssembly(List.of("LTR %DR0 %DR1", "ADDI %DR0 DATA:1"), orgF, 2);
        assertThat(resF.getDr(0)).isEqualTo(new Symbol(Config.TYPE_DATA, 2).toInt());
    }
    ...
    void testLts_True_then_False() {
        // True: top=1, second=2
        Organism orgT = Organism.create(sim, new int[]{0,0}, 1000, sim.getLogger());
        orgT.setDr(0, new Symbol(Config.TYPE_DATA, 0).toInt());
        orgT.getDataStack().push(new Symbol(Config.TYPE_DATA, 2).toInt());
        orgT.getDataStack().push(new Symbol(Config.TYPE_DATA, 1).toInt());
        Organism resT = runAssembly(List.of("LTS", "ADDI %DR0 DATA:1"), orgT, 1);
        assertThat(resT.getDr(0)).isEqualTo(new Symbol(Config.TYPE_DATA, 1).toInt());
        // False: top=2, second=1
        Organism orgF = Organism.create(sim, new int[]{0,0}, 1000, sim.getLogger());
        orgF.setDr(0, new Symbol(Config.TYPE_DATA, 0).toInt());
        orgF.getDataStack().push(new Symbol(Config.TYPE_DATA, 1).toInt());
        orgF.getDataStack().push(new Symbol(Config.TYPE_DATA, 2).toInt());
    ...
    void testGtr_True_then_False() {
        Organism orgT = Organism.create(sim, new int[]{0,0}, 1000, sim.getLogger());
        orgT.setDr(0, new Symbol(Config.TYPE_DATA, 3).toInt());
        orgT.setDr(1, new Symbol(Config.TYPE_DATA, 2).toInt());
        Organism resT = runAssembly(List.of("GTR %DR0 %DR1", "ADDI %DR0 DATA:1"), orgT, 1);
        assertThat(resT.getDr(0)).isEqualTo(new Symbol(Config.TYPE_DATA, 4).toInt());

        Organism orgF = Organism.create(sim, new int[]{0,0}, 1000, sim.getLogger());
        orgF.setDr(0, new Symbol(Config.TYPE_DATA, 1).toInt());
        orgF.setDr(1, new Symbol(Config.TYPE_DATA, 2).toInt());
        Organism resF = runAssembly(List.of("GTR %DR0 %DR1", "ADDI %DR0 DATA:1"), orgF, 1);
        assertThat(resF.getDr(0)).isEqualTo(new Symbol(Config.TYPE_DATA, 1).toInt());
    }

    @Test
    void testGti_True_then_False() {
        Organism orgT = Organism.create(sim, new int[]{0,0}, 1000, sim.getLogger());
        orgT.setDr(0, new Symbol(Config.TYPE_DATA, 2).toInt());
        Organism resT = runAssembly(List.of("GTI %DR0 DATA:1", "ADDI %DR0 DATA:1"), orgT, 1);
        assertThat(resT.getDr(0)).isEqualTo(new Symbol(Config.TYPE_DATA, 3).toInt());
    ...
    void testIftr_True_then_False() {
        // True (both DATA)
        Organism orgT = Organism.create(sim, new int[]{0,0}, 1000, sim.getLogger());
        orgT.setDr(0, new Symbol(Config.TYPE_DATA, 7).toInt());
        orgT.setDr(1, new Symbol(Config.TYPE_DATA, 9).toInt());
        Organism resT = runAssembly(List.of("IFTR %DR0 %DR1", "ADDI %DR0 DATA:1"), orgT, 1);
        assertThat(resT.getDr(0)).isEqualTo(new Symbol(Config.TYPE_DATA, 8).toInt());

        // False (DATA vs CODE)
        Organism orgF = Organism.create(sim, new int[]{0,0}, 1000, sim.getLogger());
        orgF.setDr(0, new Symbol(Config.TYPE_DATA, 7).toInt());
        orgF.setDr(1, new Symbol(Config.TYPE_CODE, 9).toInt());
        Organism resF = runAssembly(List.of("IFTR %DR0 %DR1", "ADDI %DR0 DATA:1"), orgF, 1);
        assertThat(resF.getDr(0)).isEqualTo(new Symbol(Config.TYPE_DATA, 7).toInt());
    }
    ...
    void testIfti_True_then_False() {
        ...
        // False (CODE vs DATA)
        Organism orgF = Organism.create(sim, new int[]{0,0}, 1000, sim.getLogger());
        orgF.setDr(0, new Symbol(Config.TYPE_CODE, 0).toInt());
        Organism resF = runAssembly(List.of("IFTI %DR0 DATA:123", "ADDI %DR0 DATA:1"), orgF, 1);
        assertThat(resF.getDr(0)).isEqualTo(new Symbol(Config.TYPE_CODE, 0).toInt());
    }
